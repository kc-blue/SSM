...
<html>
  ...
  <body>
  	<form action="${pageContext.request.contextPath }/items/upd.action" method="post" enctype="multipart/form-data">
	    ...
	    <table>
	    	...
	    	<tr>
	    		<td>商品生产日期</td>
	    		<td><input type="text" value="<fmt:formatDate value="${items.createtime}" pattern="yyyy-MM-dd"/>" name="createtime"></td>
	    	</tr>
	    	<tr>
	    		<td>商品图片</td>
	    			<td>
